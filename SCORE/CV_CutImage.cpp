...
vector<pair<int, int> > checkValid::horizonAreas(IplImage* img){
...
void checkValid::cutImage(IplImage* g_pBinaryImage, const char* saveFileName ){
...
void checkValid::cutImage(IplImage* g_pBinaryImage, cv::Rect rect, string saveFileName ){
