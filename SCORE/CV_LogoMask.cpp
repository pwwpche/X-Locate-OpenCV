...
cv::Rect checkValid::getLogoRect(IplImage *g_pSrcImage){
...
Mat checkValid::getLogoMask(IplImage* img)
{
...
Mat checkValid::getMaskedScene(IplImage* img){
	Mat final, logoMask;
	Mat src(img);
...
Mat checkValid::getMaskCannyScene(IplImage* img){
...
Mat checkValid::getMaskCannyLogo(IplImage* img){
