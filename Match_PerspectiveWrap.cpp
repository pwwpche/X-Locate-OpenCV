...
using namespace cv;
void MatchingHelper::sortCorners(std::vector<cv::Point2f>& corners, cv::Point2f center)
{
...
cv::Mat MatchingHelper::perspectiveWrap(Mat img, vector<cv::Point2f> corners){
...
IplImage* MatchingHelper::getWarppedImg(IplImage* srcRGB){
...
IplImage* MatchingHelper::cutAndWarp(IplImage *g_pSrcImage){
