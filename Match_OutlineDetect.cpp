...
vector<cv::Point2f> MatchingHelper::getOutlinePoints(IplImage *srcRGB){
#ifndef DEBUG_ONE
...
int MatchingHelper::findVerticleLines(CvSeq *lines, int height, int width)
{
...
int MatchingHelper::findHorizonalLines(CvSeq *lines, int height, int width)
{
	vector<double> lines_k;
	vector<double> lines_b;
	for(int i = 0;i<lines->total; ++i)
